...
<div class="container mt-5">
    ...
    <h1 class="text-center mb-4">CRUD de Prodcutos con PHP, PDO y POO </h1>
        ...
        <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3 d-flex align-item-end">
                ...
                <?php if ($productoEditar): ?>
                    <a href="index.php" class="btn btn-seconday">Cancelar edicion</a>
                <?php endif; ?>
            </form>
        </div>
    </div>
